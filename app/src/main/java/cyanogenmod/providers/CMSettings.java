...
public final class CMSettings {
    ...
    private static class NameValueCache {
        ...
        private ContentProvider lazyGetProvider(ContentResolver cr) {
            ContentProvider cp;
            synchronized (this) {
                cp = mContentProvider;
                if (cp == null && cr != null && cr.acquireContentProviderClient(mUri.getAuthority())!=null) {
                    cp = mContentProvider = (cr.acquireContentProviderClient(mUri.getAuthority())).getLocalContentProvider();
                }
            }
            return cp;
        }
        ...
        public boolean putStringForUser(ContentResolver cr, String name, String value,
            ...
            //try {
                ...
                ContentProvider cp = lazyGetProvider(cr);
                cp.call((cr.acquireContentProviderClient(name)).getLocalContentProvider().getContext().getPackageName(), mCallSetCommand, arg);
        ...
        public String getStringForUser(ContentResolver cr, String name, final int userId) {
            final boolean isSelf = (userId == android.os.Process.myUid());
            if (isSelf) {
                ...
                if (LOCAL_LOGV) Log.v(TAG, "get setting for user " + userId
                        + " by user " + android.os.Process.myUid() + " so skipping cache");
            }
            ...
            if (mCallGetCommand != null) {
                try {
                    ...
                    Bundle b = cp.call((cr.acquireContentProviderClient(name)).getLocalContentProvider().getContext().getPackageName(), mCallSetCommand, args);
                    if (b != null) {
    ...
    private static final class DelimitedListValidator implements Validator {
        private final ArrayList<String> mValidValueSet;
        private final String mDelimiter;
        private final boolean mAllowEmptyList;

        public DelimitedListValidator(String[] validValues, String delimiter,
                                      boolean allowEmptyList) {
            mValidValueSet = new ArrayList<>();
            mValidValueSet.addAll(Arrays.asList(validValues));
    ...
    public static final class System extends Settings.NameValueTable {
        ...
        public static String getString(ContentResolver resolver, String name) {
            return getStringForUser(resolver, name, android.os.Process.myUid());
        }
        ...
        public static boolean putString(ContentResolver resolver, String name, String value) {
            return putStringForUser(resolver, name, value, android.os.Process.myUid());
        }
        ...
        public static int getInt(ContentResolver cr, String name, int def) {
            return getIntForUser(cr, name, def, android.os.Process.myUid());
        }
        ...
        public static int getInt(ContentResolver cr, String name)
            ...
            return getIntForUser(cr, name, android.os.Process.myUid());
        }
        ...
        public static boolean putInt(ContentResolver cr, String name, int value) {
            return putIntForUser(cr, name, value, android.os.Process.myUid());
        }
        ...
        public static long getLong(ContentResolver cr, String name, long def) {
            return getLongForUser(cr, name, def, android.os.Process.myUid());
        }
        ...
        public static long getLong(ContentResolver cr, String name)
                throws CMSettingNotFoundException {
            return getLongForUser(cr, name, android.os.Process.myUid());
        }
        ...
        public static boolean putLong(ContentResolver cr, String name, long value) {
            return putLongForUser(cr, name, value, android.os.Process.myUid());
        }
        ...
        public static float getFloat(ContentResolver cr, String name, float def) {
            return getFloatForUser(cr, name, def, android.os.Process.myUid());
        }
        ...
        public static float getFloat(ContentResolver cr, String name)
                throws CMSettingNotFoundException {
            return getFloatForUser(cr, name, android.os.Process.myUid());
        }
        ...
        public static boolean putFloat(ContentResolver cr, String name, float value) {
            return putFloatForUser(cr, name, value, android.os.Process.myUid());
        }
        ...
        public static final String[] LEGACY_SYSTEM_SETTINGS = new String[]{
                System.NAV_BUTTONS,
                System.KEY_HOME_LONG_PRESS_ACTION,
                System.KEY_HOME_DOUBLE_TAP_ACTION,
                System.BACK_WAKE_SCREEN,
                System.MENU_WAKE_SCREEN,
                System.VOLUME_WAKE_SCREEN,
                System.KEY_MENU_ACTION,
                System.KEY_MENU_LONG_PRESS_ACTION,
                System.KEY_ASSIST_ACTION,
                System.KEY_ASSIST_LONG_PRESS_ACTION,
                System.KEY_APP_SWITCH_ACTION,
                System.KEY_APP_SWITCH_LONG_PRESS_ACTION,
                System.HOME_WAKE_SCREEN,
                System.ASSIST_WAKE_SCREEN,
                System.APP_SWITCH_WAKE_SCREEN,
                System.CAMERA_WAKE_SCREEN,
                System.CAMERA_SLEEP_ON_RELEASE,
                System.CAMERA_LAUNCH,
                System.SWAP_VOLUME_KEYS_ON_ROTATION,
                System.BATTERY_LIGHT_ENABLED,
                System.BATTERY_LIGHT_PULSE,
                System.BATTERY_LIGHT_LOW_COLOR,
                System.BATTERY_LIGHT_MEDIUM_COLOR,
                System.BATTERY_LIGHT_FULL_COLOR,
                System.ENABLE_MWI_NOTIFICATION,
                System.PROXIMITY_ON_WAKE,
                System.ENABLE_FORWARD_LOOKUP,
                System.ENABLE_PEOPLE_LOOKUP,
                System.ENABLE_REVERSE_LOOKUP,
                System.FORWARD_LOOKUP_PROVIDER,
                System.PEOPLE_LOOKUP_PROVIDER,
                System.REVERSE_LOOKUP_PROVIDER,
                System.DIALER_OPENCNAM_ACCOUNT_SID,
                System.DIALER_OPENCNAM_AUTH_TOKEN,
                System.DISPLAY_TEMPERATURE_DAY,
                System.DISPLAY_TEMPERATURE_NIGHT,
                System.DISPLAY_TEMPERATURE_MODE,
                System.DISPLAY_AUTO_OUTDOOR_MODE,
                System.DISPLAY_CABC,
                System.DISPLAY_COLOR_ENHANCE,
                System.DISPLAY_COLOR_ADJUSTMENT,
                System.LIVE_DISPLAY_HINTED,
                System.DOUBLE_TAP_SLEEP_GESTURE,
                System.STATUS_BAR_SHOW_WEATHER,
                System.RECENTS_SHOW_SEARCH_BAR,
                System.NAVBAR_LEFT_IN_LANDSCAPE,
                System.T9_SEARCH_INPUT_LOCALE,
                System.BLUETOOTH_ACCEPT_ALL_FILES,
                System.LOCKSCREEN_PIN_SCRAMBLE_LAYOUT,
                System.SHOW_ALARM_ICON,
                System.STATUS_BAR_IME_SWITCHER,
                System.QS_SHOW_BRIGHTNESS_SLIDER,
                System.STATUS_BAR_BRIGHTNESS_CONTROL,
                System.VOLBTN_MUSIC_CONTROLS,
                System.USE_EDGE_SERVICE_FOR_GESTURES,
                System.STATUS_BAR_NOTIF_COUNT,
                System.CALL_RECORDING_FORMAT,
                System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL,
                System.NOTIFICATION_LIGHT_MULTIPLE_LEDS_ENABLE,
                System.NOTIFICATION_LIGHT_SCREEN_ON,
                System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR,
                System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON,
                System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF,
                System.NOTIFICATION_LIGHT_PULSE_CALL_COLOR,
                System.NOTIFICATION_LIGHT_PULSE_CALL_LED_ON,
                System.NOTIFICATION_LIGHT_PULSE_CALL_LED_OFF,
                System.NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR,
                System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_ON,
                System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_OFF,
                System.NOTIFICATION_LIGHT_PULSE_CUSTOM_ENABLE,
                System.NOTIFICATION_LIGHT_PULSE_CUSTOM_VALUES,
                System.STATUS_BAR_QUICK_QS_PULLDOWN,
                System.VOLUME_ADJUST_SOUNDS_ENABLED,
                System.SYSTEM_PROFILES_ENABLED,
                System.INCREASING_RING,
                System.INCREASING_RING_START_VOLUME,
                System.INCREASING_RING_RAMP_UP_TIME,
                System.STATUS_BAR_CLOCK,
                System.STATUS_BAR_AM_PM,
                System.STATUS_BAR_BATTERY_STYLE,
                System.STATUS_BAR_SHOW_BATTERY_PERCENT,
                System.VOLUME_KEYS_CONTROL_RING_STREAM,
                System.NAVIGATION_BAR_MENU_ARROW_KEYS,
                System.HEADSET_CONNECT_PLAYER,
                System.ZEN_ALLOW_LIGHTS,
                System.TOUCHSCREEN_GESTURE_HAPTIC_FEEDBACK,
        };
    ...
    public static final class Secure extends Settings.NameValueTable {
        ...
        public static final String[] LEGACY_SECURE_SETTINGS = new String[]{
                Secure.ADVANCED_MODE,
                Secure.BUTTON_BACKLIGHT_TIMEOUT,
                Secure.BUTTON_BRIGHTNESS,
                Secure.DEFAULT_THEME_COMPONENTS,
                Secure.DEFAULT_THEME_PACKAGE,
                Secure.DEV_FORCE_SHOW_NAVBAR,
                Secure.KEYBOARD_BRIGHTNESS,
                Secure.POWER_MENU_ACTIONS,
                Secure.STATS_COLLECTION,
                Secure.QS_SHOW_BRIGHTNESS_SLIDER,
                Secure.QS_TILES,
                Secure.QS_USE_MAIN_TILES,
                Secure.NAVIGATION_RING_TARGETS[0],
                Secure.NAVIGATION_RING_TARGETS[1],
                Secure.NAVIGATION_RING_TARGETS[2],
                Secure.RECENTS_LONG_PRESS_ACTIVITY,
                Secure.ADB_NOTIFY,
                Secure.ADB_PORT,
                Secure.DEVICE_HOSTNAME,
                Secure.KILL_APP_LONGPRESS_BACK,
                Secure.PROTECTED_COMPONENTS,
                Secure.LIVE_DISPLAY_COLOR_MATRIX,
                Secure.ADVANCED_REBOOT,
                Secure.THEME_PREV_BOOT_API_LEVEL,
                Secure.LOCKSCREEN_TARGETS,
                Secure.RING_HOME_BUTTON_BEHAVIOR,
                Secure.PRIVACY_GUARD_DEFAULT,
                Secure.PRIVACY_GUARD_NOTIFICATION,
                Secure.DEVELOPMENT_SHORTCUT,
                Secure.PERFORMANCE_PROFILE,
                Secure.APP_PERFORMANCE_PROFILES_ENABLED,
                Secure.QS_LOCATION_ADVANCED,
                Secure.LOCKSCREEN_VISUALIZER_ENABLED,
    ...
    public static final class Global extends Settings.NameValueTable {
         ...
         * @hide
         * @deprecated Use {@link Settings.Global#CHARGING_SOUNDS_ENABLED} instead
         */
        @Deprecated
        ...
        public static final String[] LEGACY_GLOBAL_SETTINGS = new String[]{
                ...
                Global.ZEN_DISABLE_DUCKING_DURING_MEDIA_PLAYBACK,
                Global.WIFI_AUTO_PRIORITIES_CONFIGURATION
        };
